const LinkText = ({str,arrowClass}) =>{
    return(
        <div className="flex gap-2 justify-start items-center">
            <h6 className="text-red font-semibold uppercase underline">{str}</h6>
            <svg className={arrowClass} xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 0 43 42" fill="none">
