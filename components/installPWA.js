...
const InstallPWA = ({text}) => {
  ...
  return (
    <div className="grow flex gap-2 justify-start items-center text-white cursor-pointer" onClick={handleInstall}>
        <h6 className="text-red font-semibold uppercase underline">{text}</h6>
