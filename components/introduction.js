...
const Intro = ({app}) => {
    ...
    useEffect(()=>{
        let ctx = gsap.context(()=>{
            ...
            .to(ampersandWrapper.current,{translateY:0,duration:2,ease:"power3.inOut"},"-=1.85")
    ...
    return (
        <div ref={introductionContent} className="snap-start introBody p-4 grid grid-cols-4 h-screen gap-2 grid-rows-mobileLayout md:gap-4 md:grid-cols-12 md:grid-rows-layout">
            ...
            <div className="reel relative overflow-hidden flex flex-col gap-4 row-start-2 row-span-2 col-start-1 col-span-4 md:col-start-7 md:col-span-3 md:row-start-2 md:row-span-2">
                <div className="absolute bottom-0 right-0 flex z-10 p-4 mix-blend-exclusion">
