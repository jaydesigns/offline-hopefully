...
const TextSlider = ({wrap,refr,heading,gridPos,firstWord,secondWord}) => {
    ...
    let headingList = `${heading} text-[11.5vw] md:text-[10.5vw] font-semibold text-black tracking-tighter uppercase leading-none`
    return (
...
const Intro = ({app}) => {
    ...
    return (
        <div style={{opacity:0}} ref={introductionContent} className="snap-start introBody px-4 pb-4 pt-32 md:pt-4 grid grid-cols-4 h-screen gap-2 grid-rows-mobileLayout md:grid-cols-12 md:grid-rows-layout">
            ...
            <div className="funFact flex leading-tight text-msm md:text-sm row-start-6 md:row-start-5 md:col-start-2 col-span-2">
                <div className="clip flex flex-col justify-center md:justify-end pb-4">
