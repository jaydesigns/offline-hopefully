const ArrowRight = ({color,classToAdd,fn,style}) => {
    const fullClass = `${classToAdd}`
    return(
        <div onClick={fn} className="flex flex-col justify-center align-center h-full">
            <div className="flex justify-center">
            <svg className={fullClass} style={style} width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
