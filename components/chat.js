...
const ChatHeader = ({step,chatHeader,firstName})=>{
    ...
    return(
        ...
        {(step===2)&&<ChatHeaderInnerText chatHeader={chatHeader} str={`Hi ${firstName}! Nice to have you here. Can I help you with anything?`}/>}
        {(step===3)&&<ChatHeaderInnerText chatHeader={chatHeader} str={"Third step"}/>}
        {(step===4)&&<ChatHeaderInnerText chatHeader={chatHeader} str={"Fourth step"}/>}
        {(step>4)&&<ChatHeaderInnerText chatHeader={chatHeader} str={"Thanks for taking interest in my work. I'd like to know your name."}/>}
        </>
    )
}
