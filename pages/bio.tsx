            ...
            <div className="p-4 text-black pb-28">
                ...
                <div className="bio flex flex-col gap-8 pt-28">
                    <div className="grid grid-cols-4 md:grid-cols-12">
                        ...
                        <h2 className="clip font-semibold text-lg md:text-3xl col-start-1 md:col-start-5 md:col-span-3">Education</h2>
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-12">
                        ...
                        <h2 className="clip font-semibold text-lg md:text-3xl col-start-1 md:col-start-5 md:col-span-3">Awards</h2>
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-12">
                        ...
                        <h2 className="clip font-semibold text-lg md:text-3xl col-start-1 md:col-start-5 md:col-span-3">Skills</h2>
